...
public abstract class GifActor extends Actor
{
    ...
    private class GifDecoder {
      ...
      /**
       * Displays points gained on the screen
       * 
       * @param int points gained
       *        int x position of GIFActor
       *        int y position of GIFActor
       */
      public void visualPoints(int points, int x, int y) {
          SWorld world = (SWorld)(getWorld());
          GreenfootImage img = world.getBackground();
          img.setColor(java.awt.Color.BLACK);
          img.setTransparency(255);
          img.drawString("+" + points,x,y);
      }
