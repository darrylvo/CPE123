...
/* Jessica found the source code online
most levels were designed by darryl, jessica, and mark   
   Darryl and lenoy made the health code
 */
/**
...
public class SWorld extends World
{
    ...
    public SWorld(int wide, int high, int cellSize, int scrollWide, int scrollHigh)
    {
        ...
        /* darryl- the c integer handles how much health you have, and redraws the heart depending on your hp
         * 
         */
        timer.mark();
        if (c==5)
        {
             heart2 = new Heart();
            addObject(heart2, 60, 48,false);
            heart2.setLocation(32, 28);
            heart3 = new Heart();
            addObject(heart3, 91, 34,false);
            heart3.setLocation(75, 28);
            heart4 = new Heart();
            addObject(heart4, 172, 54,false);
            heart4.setLocation(118, 29);
            addObject(heart1,159,30,false);
            addObject(heart,192,30,false);
        ...
        addObject(stage2timer, 780, 27, false);
        
        manabar = new ManaBar(300, 300);
        regenCounter = 0;
        
        addObject(scoreboard, 921, 36,false);
        scoreboard.setLocation(607, 25);
    }
    ...
    public void shake(Heart h) {
        /* fancy animation for heart removing-darryl
         * 
         */
    ...
    public void setHearts() {
        /* this changed the amount of hearts displayed on screen once you get damaged. it constantly checks for what c is,
         * and if c goes down it will remove teh heart -darryl
         */
        try {
            if(heart4.getY()>100) 
            {
    ...
    public void damage()
    {
        /*darryl- every time you get damaged, it calls this funnction to subract the c integer. there is also a delay function so that 
         * all of your hp doesnt go down at once
         */
    ...
    {
        /* damage function with a different sound-darryl
         * 
         */
    ...
    /**
     * Returns the height of the scrolling area of the universew
     *
    ...
    public void showVisual(String s, int x, int y) {
        ...
        addObject(visual,scrolledX + x,scrolledY + y);
    }
